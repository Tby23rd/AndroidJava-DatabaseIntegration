...
public class StudentAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (i == 0){
            ...
            txtViewStudId.setTextColor(Color.parseColor("#232323"));
            txtViewStudName.setTextColor(Color.parseColor("#232323"));
            txtViewStudDept.setTextColor(Color.parseColor("#232323"));
        }
